...
# load_gold / fact_collaboration were retired alongside Task 87 (2026-09-12):
# fully derived, confirmed dead (no Django view, no wired-up analytics query),
# and the cheapest real weight to shed once Neon's free-tier storage cap
# started to bind. See warehouse/ddl/23_reclaim_warehouse_storage.sql.
