...
-- Task 90: dim_series_video, an exact copy of dim_movie_video above with
-- series_id in place of movie_id — same naming reasoning, same REPLACE (not
-- upsert) load strategy via _replace_by_parent(). See 24_series_videos.sql.
